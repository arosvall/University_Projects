...
Scene Scene::shapeScene() {
	...
	objects.push_back(std::make_shared<SceneObject>(
		std::make_shared<Triangle>(glm::vec3(1.3, -0.8, -5.0), glm::vec3(0.2, 0.3, -3.5), glm::vec3(0.95, 0.9, -5.9)), white
	));

	objects.push_back(std::make_shared<SceneObject>(
		std::make_shared<Disc>(glm::vec3(3, 0, -5), glm::vec3(3, 0, -5), .8), white
	));

	objects.push_back(std::make_shared<SceneObject>(
		std::make_shared<Plane>(glm::vec3(0, -1, -10), glm::vec3(0,-1,0)), white
		));
